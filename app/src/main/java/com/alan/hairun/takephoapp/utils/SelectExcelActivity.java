...
import com.alan.hairun.takephoapp.adapter.SelectBaseMapAdapter;
import com.alan.hairun.takephoapp.bean.FileEntity;
 ...
 * excel数据导入
 */
public class SelectExcelActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
...
//        initWindowSize();
    ...
    private void initData() {
        ...
        //根目录
        m_folderName = MainActivity.FATH;
    ...
    private void initView() {
        ...
        m_tvTitle = findViewById(R.id.tvTitle2);
        m_tvConfig = findViewById(R.id.tvSave);
        m_listView = findViewById(R.id.listView);
        m_tvReturn = findViewById(R.id.tvReturn);
        m_btnReturn = findViewById(R.id.btnReturn);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btnReturn:
            case R.id.tvTitle2:
                if (!m_folderName.equals(MainActivity.SD)) {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (_fileEntity.getFileType() == FileEntity.Type.FLODER) {
            ...
            m_tvTitle.setText(m_folderName);
            m_handler.sendEmptyMessage(0);
        } else if (m_folderName.endsWith(".xls")) {
            //未选择变选中
            if (m_itemPosition == -1) {
